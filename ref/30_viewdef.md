...
By default, it uses context variables, but it can be provided with specif context in `data` parameter.
...
* HttpRequest - request object that initiated the call
...
**TODO** - explain list of operations
